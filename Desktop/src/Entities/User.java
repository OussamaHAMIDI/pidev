...
public class User {
    ...
    // avec photo
    public User(int id, String userName, String mdp, EtatUser etat, TypeUser type, String nom, String prenom, LocalDate dateNaissance, String Sexe, String email, String adresse, String tel, LocalDateTime lastLogin, String salt, String role, String token, String photo) {
        this.id = id;
 ...
 // sans photo
    ...
    public String toString() {
        return "User{" + "id=" + id + ", userName=" + userName + ", mdp=" + mdp + ", etat=" + etat + ", type=" + type + ", nom=" + nom + ", prenom=" + prenom + ", dateNaissance=" + dateNaissance + ", Sexe=" + Sexe + ", email=" + email + ", adresse=" + adresse + ", tel=" + tel + ", lastLogin=" + lastLogin + ", salt=" + salt + ", role=" + role + ", token=" + token + ", photo=" + photo + '}';
    }
