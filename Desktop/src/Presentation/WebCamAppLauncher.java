...
//import controller.Client_InscriController;
...
//							System.out.println("Captured Image height*width:"+grabbedImage.getWidth()+"*"+grabbedImage.getHeight());
	...
	protected void stopWebCamCamera() {
            ...
            System.out.println("captured"+bufferedImage);
            WritableImage image = (WritableImage) SwingFXUtils.toFXImage(bufferedImage, null);
            
            //iv = new ImageView(image);
            setZo(image);
            System.out.println("iv "+iv);
//            File image2 = new File(ta_photoprofil.getText());
//            fis = new FileInputStream(image2);
//            img = (int) image2.length();
            setCapture(webCam.getImage());
		stopCamera = true;
    ...
    public Button getBtnCamreaStop() {
        return btnCamreaStop;
    }

    public void setBtnCamreaStop(Button btnCamreaStop) {
        this.btnCamreaStop = btnCamreaStop;
    }
    ...
    public static Image getZo() {
        return zo;
    }

    public static void setZo(Image zo) {
        WebCamAppLauncher.zo = zo;
    }
