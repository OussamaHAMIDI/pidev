...
public class AccueilController implements Initializable {
    ...
    public void setAccueil() {
        if (userConnected != null) {
            ...
            photoUser.setFill(new ImagePattern(new Image(Utils.dir + userConnected.getPhoto())));
        ...
        supprimerCompte.setOnAction(event -> {
            ...
            alert.resultProperty().addListener((observable, oldValue, newValue) -> {
                if (newValue == ButtonType.OK) {
                    ...
                    Utils.showTrayNotification(NotificationType.CUSTOM, "Informations", null, "Ce compte a été supprimé", userConnected.getPhoto(), 6000);
                    userConnected = null;
                    setAccueil();
                }
            });
