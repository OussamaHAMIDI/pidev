...
public class ModifierProduitController implements Initializable {
    ...
    public void modifierProduit(ActionEvent event) {
        ...
        if (controleDeSaisi()) {
            ...
            Produit pro = new Produit(p.getId(), reference.getText(), libelle.getText(), description.getText(),
...
//            pro.setPhoto(pro.getPhoto());
            ...
            if (photoProduit != null) {
                ...
                pro.setPhoto(photoProduit);
                photoProduit = null;
            }
            ps.modifierProduit(pro);
            MenuProduitsController.list.set(MenuProduitsController.list.indexOf(p), pro);
            bc.setValues(pro);
            selectedProduit = pro;
