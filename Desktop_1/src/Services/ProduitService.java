...
public class ProduitService implements IProduit {
    ...
    public boolean ajouterProduit(Produit p) {
        try {
            String req = "INSERT INTO produit (id_boutique,reference,libelle,description,prix,taille,couleur,texture,poids) values ( ?,?,?,?,?,?,?,?,?)";                                              
            ...
            ps.setString(7, p.getCouleur());
            ps.setString(8, p.getTexture());
