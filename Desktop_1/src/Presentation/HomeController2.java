...
public class HomeController2 implements Initializable {
    ...
    @FXML
    private Label exit, tanggal, jam, emailUser, namaUser, usernameUser, idUser, levelUser;
    ...
    private void handleExitClicked(){
        ...
        if (result.get() == ButtonType.OK){
            User u = us.getUserById(Integer.getInteger(idUser.getText()));
            u.setEtat(EtatUser.Disconnected);
            System.exit(0);
        } 
    }
    @FXML
    ...
    private void setMenu(){
        if(levelUser.getText().equals("Administrateur")){
            admin.setVisible(true);
            operator.setVisible(false);
            user.setVisible(false);
        }
        else if (levelUser.getText().equals("Artisan")){
    ...
    private void setValueModel(){
        User u = us.getUserById(Integer.getInteger(idUser.getText()));
        usernameUser.setText(u.getUserName());
        emailUser.setText(u.getEmail());
        namaUser.setText(u.getNom());
    ...
    private void logout(ActionEvent event) throws IOException{
        ...
        alert.setHeaderText(null);
        alert.setContentText("Vous voulez vraiment vous déconnecter ?");
        ...
        if (result.get() == ButtonType.OK){
            ...
            tray.setMessage("Bye "+namaUser.getText());
            tray.setAnimationType(AnimationType.FADE);
            tray.showAndDismiss(Duration.millis(1500));
            tray.setRectangleFill(Color.valueOf("#4183D7"));
            tray.setImage(new Image(us.getUserById(Integer.getInteger(idUser.getText())).getPhoto()));
