...
public class EvaluationService {
    ...
    public Evaluation ajouterEvaluation(Evaluation e) {
        try {
            ConnectionRequest r = new ConnectionRequest();
            r.setPost(true);
            r.setHttpMethod("GET");
            r.setUrl("http://localhost/pidev/WEB/web/app_dev.php/api/evaluation/add");
            ...
            e = new Evaluation(response.get("id").toString(), response.get("date").toString(), user,
                    boutique, note);
            return e;
    ...
    public List<Evaluation> getEvaluations() {
        ...
        try {
            ...
            Double no = (Double) b.get("note");
            int note = no.intValue();
            Evaluation e = new Evaluation(response.get("id").toString(), response.get("date").toString(), user,
                    boutique, note);
            evaluations.add(e);
            }
