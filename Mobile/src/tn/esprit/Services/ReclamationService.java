...
public class ReclamationService {
    ...
    public List<Reclamation> getReclamationsUser(String id) {
        ...
        try {
            ...
            r.setUrl("http://localhost/pidev/WEB/web/app_dev.php/api/reclamation/allUser/" + id);
            r.setPost(false);
            r.setHttpMethod("GET");
            InfiniteProgress prog = new InfiniteProgress();
            Dialog dlg = prog.showInifiniteBlocking();
    ...
    public Reclamation deleteReclamation(String id) {
        try {
            ConnectionRequest r = new ConnectionRequest();
            r.setPost(true);
            r.setHttpMethod("GET");
            r.setUrl("http://localhost/pidev/WEB/web/app_dev.php/api/reclamation/delete/" + id);
