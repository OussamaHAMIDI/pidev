...
public class ProduitEditForm extends Form {

    static Resources res;
    String path = null;
    
    public ProduitEditForm(Produit produit) {
        super("Modifier un produit", new BorderLayout());
        this.res = Main.stheme;

        this.setScrollableY(true);
        this.setLayout(new BorderLayout());

TextField ref = new TextField(produit.getReference(), "Reference");
    TextField nom = new TextField(produit.getLibelle(), "Libellé");
    TextArea description = new TextArea(produit.getDescription());
    TextField prix = new TextField(""+produit.getPrix()+"", "prix");
    TextField taille = new TextField(""+produit.getTaille()+"", "taille");
    TextField couleur = new TextField(produit.getCouleur(), "couleur");
    TextField texture = new TextField(produit.getTexture(), "texture");
    TextField poids = new TextField(""+produit.getPoids()+"", "poids"); 
    TextField quantite = new TextField(""+produit.getQuantite(), "quantite");
...
//                String d = s.format(new Date());
                ...
                p.setBoutique(produit.getBoutique());
