 ...
 * @ORM\Entity(repositoryClass="PanierRepository\Repository\PanierRepository")
 */
class Panier
{
    ...
    public function newPanier( \DateTime $dateCreation, \DateTime $dateLivraison, string $totalTtc, string $fraisLivraison, string $statut, string $modePaiement, string $modeLivraison, bool $estLivre, bool $estPaye, User $idUser)
    {
