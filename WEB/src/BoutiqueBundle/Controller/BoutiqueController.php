...

{
    ...
    {
        $em= $this->getDoctrine()->getManager();
        $boutiques=$em->getRepository("BoutiqueBundle:Boutique")->findBy(array(
            'idUser'=>$id
            ));

        return $this->render('@Boutique/Boutique/afficher_boutique_artisan.html.twig', array(
            "boutiques"=>$boutiques
        ));
    }
    ...
    public function chercherBoutiqueAction(Request $request)
    {
        ...
        $boutiques = $em->getRepository('BoutiqueBundle:Boutique')->rechercheAction($parameter);
        return $this->render('@Boutique/Boutique/recherche.html.twig', array(
            "boutiques" => $boutiques
        ));
    }
